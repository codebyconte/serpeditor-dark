  ...
  return (
    <>
      <Main>
        ...
        {/* Stats Section */}
        <Section id="stats" className="bg-primary/5">
          <div className="flex flex-col items-center gap-4 text-center">
            <Text className="text-lg font-semibold">
              Déjà <strong className="text-primary">12 450+</strong> analyses de backlinks effectuées ce mois-ci.
            </Text>
          </div>
        </Section>
          ...
          cta={
            <div className="flex flex-col items-center gap-4">
              ...
              <Text className="text-sm text-mist-600 dark:text-mist-500">
                Accès complet pendant 7 jours : Vue d&apos;ensemble, Ancres, Nouveaux/Perdus et Domaines référents.
              </Text>
              <Text className="text-sm text-mist-600 dark:text-mist-500">
                ✅ Pas besoin de carte bancaire - ✅ Inscription en 30 secondes - ✅ Résiliation en 1 clic
              </Text>
              <Text className="text-sm text-mist-600 dark:text-mist-500">
