...
export function KeywordsTable({
 ...
 <Checkbox
 onCheckedChange={() =>
 onToggleAll(displayData.map((item) => item.keyword))
 }
 ...
 {(item.keyword_info?.search_volume || 0).toLocaleString(
 'fr-FR',
 )}
 </TableCell>
 <TableCell className="text-right">
 ...
 <TooltipContent>
 <p>
 Difficulté SEO: Plus le score est élevé, plus le mot-clé
 est difficile à ranker
 </p>
 </TooltipContent>
 </Tooltip>
 </TableCell>
