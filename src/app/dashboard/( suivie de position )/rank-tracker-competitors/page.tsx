      ...
      <div className="mx-auto max-w-7xl">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full rounded-xl border-2 border py-3 pr-4 pl-12 text-lg transition-all focus:border-ring focus:ring-4 focus:ring-ring/20"
                  disabled={loading}
                />
              </div>
            </div>
        ...
        {!loading && competitorsData && (
          <div>
            ...
            <div className="mb-6 flex items-center justify-between rounded-xl border-2 border-primary/30 bg-gradient-to-r from-primary/5 to-primary/10 p-6 shadow-sm">
