...
export default function SERPAnalyzerPro({
 ...
 <div className="bg-card rounded-xl border-2-primary/20 bg-gradient-to-r from-primary/5 to-primary/10 p-6 shadow-sm">
...
function MetricCard({
 ...
 return (
 <div className="bg-card rounded-xl border-2-border p-6 shadow-sm">
...
function ComparisonView({
 ...
 <div className="rounded-xl border-2-green-200 bg-green-50 p-6 shadow-sm">
 <div className="flex items-start justify-between">
 ...
 <div className="rounded-xl border-2-red-200 bg-red-50 p-6 shadow-sm">
 <div className="flex items-start justify-between">
 <div className="flex items-center gap-3">
 ...
 <div className="rounded-xl border-2-blue-200 bg-blue-50 p-6 shadow-sm">
 <div className="flex items-start justify-between">
 <div className="flex items-center gap-3">
 ...
 <div className="overflow-hidden rounded-xl border-2-yellow-200 bg-yellow-50 shadow-sm">
 ...
 <div className="overflow-hidden rounded-xl border-2-green-200 bg-green-50 shadow-sm">
 ...
 <div className="overflow-hidden rounded-xl border-2-blue-200 bg-blue-50 shadow-sm">
 ...
 <div className="overflow-hidden rounded-xl border-2-red-200 bg-red-50 shadow-sm">
...
function FeaturesView({ analytics }: { analytics: any }) {
 ...
 <div
 key={type}
 className="bg-card rounded-xl border-2-border p-6 shadow-sm hover:shadow-md"
 >
 <div className="flex items-center justify-between">
 <div className="flex-1">
 <h4 className="dashboard-heading-4">
