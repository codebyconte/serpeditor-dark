                            ...
                            <CardContent className="pt-6">
                              <div className="flex items-start justify-between">
                                <div className="flex-1">
                                  ...
                                  <p className="mt-2 text-3xl font-bold text-purple-600 lg:text-4xl dark:text-purple-400">
                        ...
                        <CardContent className="w-full max-w-full min-w-0 space-y-6 overflow-x-hidden pt-6">
                          ...
                          {item.answer && (
                            <div className="w-full max-w-full min-w-0 overflow-x-hidden">
                              ...
                              <div className="w-full max-w-full min-w-0 overflow-x-auto rounded-lg border-2 border-purple-200 bg-gradient-to-br from-purple-50/50 to-pink-50/50 p-4 dark:border-purple-800 dark:from-purple-950/20 dark:to-pink-950/20">
                                <div
                          ...
                          {item.ai_monthly_searches &&
                            item.ai_monthly_searches.length > 0 && (
                              <Card className="w-full max-w-full min-w-0 overflow-x-hidden border-2 border-purple-500/20 bg-gradient-to-br from-purple-500/5 to-transparent">
