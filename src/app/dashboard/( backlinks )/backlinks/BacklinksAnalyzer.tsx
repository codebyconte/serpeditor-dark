...
function OverviewView({ stats }: { stats: BacklinkStats }) {
 ...
 <div className="rounded-xl border-2-red-200 bg-red-50 p-6">
 <div className="flex items-center gap-3">
 ...
 <h3 className="mb-4 text-lg font-bold text-foreground">Top Pays</h3>
 ...
 {/* Top TLDs */}
 <div className="rounded-xl border border bg-card p-6 shadow-sm">
 <h3 className="mb-4 text-lg font-bold text-foreground">Top TLDs</h3>
...
function AnchorsView({
 ...
 <div className="rounded-xl border bg-card shadow-sm">
 <div className="border-b border px-6 py-4">
 <h3 className="font-semibold text-foreground">Top Anchor Texts</h3>
 </div>
 <div className="divide-y divide-gray-100">
 ...
 >
 <div className="flex-1">
 <div className="font-medium text-foreground">{item.anchor}</div>
 </div>
