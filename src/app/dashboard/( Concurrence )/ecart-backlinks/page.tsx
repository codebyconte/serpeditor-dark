...
export default function DomainIntersectionAnalyzerPage() {
 ...
 className="flex-1 rounded-xl border-2 px-4 py-3 focus:border-ring focus:ring-4 focus:ring-ring/20"
 disabled={loading}
 />
 {targets.length > 2 && (
 <button
 ...
 disabled={loading}
 className="rounded-lg border-2-destructive/50 bg-destructive/10 p-3 text-destructive hover:bg-red-100 disabled:opacity-50"
 >
 <X className="h-5 w-5" />
 </button>
 )}
 ...
 onClick={addTarget}
 disabled={loading}
 className="mt-3 flex w-full items-center justify-center gap-2 rounded-xl border-2-dashed border bg-card py-3 text-sm font-semibold text-foreground hover:border-gray-400 hover:bg-muted disabled:opacity-50"
 >
 ...
 className="flex-1 rounded-lg border-2 px-3 py-2 focus:border-blue-500 focus:ring-2 focus:ring-blue-500"
 disabled={loading}
 />
 <button
 type="button"
