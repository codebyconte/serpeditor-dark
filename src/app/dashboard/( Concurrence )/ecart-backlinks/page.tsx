      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div className="mb-8">
          <h1 className="text-4xl font-bold text-gray-900">
            Analyseur d&apos;Intersection de Domaines
          </h1>
          <p className="mt-2 text-lg text-gray-600">
            Trouvez les sites qui pointent vers plusieurs de vos concurrents
          </p>
        </div>
          ...
          <form onSubmit={handleSearch} className="space-y-6">
            ...
            <div className="rounded-xl border-2 border-blue-200 bg-blue-50 p-4">
              <div className="flex items-start gap-3">
                <GitMerge className="h-5 w-5 flex-shrink-0 text-blue-600" />
            ...
            <div>
                ...
                {targets.map((target, index) => (
                  <div key={index} className="flex items-center gap-3">
                    ...
                    <input
                      ...
                      className="flex-1 rounded-xl border-2 border-gray-200 px-4 py-3 focus:border-blue-500 focus:ring-4 focus:ring-blue-500/20"
                      disabled={loading}
                    />
                    {targets.length > 2 && (
                      <button
                        ...
                        disabled={loading}
                        className="rounded-lg border-2 border-red-200 bg-red-50 p-3 text-red-600 hover:bg-red-100 disabled:opacity-50"
                      >
                        <X className="h-5 w-5" />
                      </button>
                    )}
              ...
              {targets.length < 20 && (
                <button
                  ...
                  onClick={addTarget}
                  disabled={loading}
                  className="mt-3 flex w-full items-center justify-center gap-2 rounded-xl border-2 border-dashed border-gray-300 bg-gray-50 py-3 text-sm font-semibold text-gray-700 hover:border-gray-400 hover:bg-gray-100 disabled:opacity-50"
                >
                ...
                <div className="space-y-3 rounded-xl border border-gray-200 bg-gray-50 p-4">
                    ...
                    excludeTargets.map((exclude, index) => (
                      <div key={index} className="flex items-center gap-3">
                        <input
                          ...
                          className="flex-1 rounded-lg border-2 border-gray-200 px-3 py-2 focus:border-blue-500 focus:ring-2 focus:ring-blue-500"
                          disabled={loading}
                        />
                        <button
                          type="button"
                  ...
                  {excludeTargets.length < 10 && (
                    <button
                      ...
                      disabled={loading}
                      className="flex w-full items-center justify-center gap-2 rounded-lg border border-dashed border-gray-300 bg-white py-2 text-sm font-medium text-gray-700 hover:bg-gray-50"
                    >
                      <Plus className="h-4 w-4" />
