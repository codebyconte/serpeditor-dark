      ...
      <div className="rounded-xl border border-gray-200 bg-white p-6 shadow-sm">
        ...
        <div className="grid grid-cols-1 gap-3 md:grid-cols-2 lg:grid-cols-3">
          {Object.entries(targets).map(([id, domain]) => (
            <div
              key={id}
              className="flex items-center gap-3 rounded-lg border-2 border-purple-200 bg-purple-50 p-4"
            >
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center gap-1 font-medium text-gray-900 hover:text-blue-600 hover:underline"
                >
                  {item.domain}
