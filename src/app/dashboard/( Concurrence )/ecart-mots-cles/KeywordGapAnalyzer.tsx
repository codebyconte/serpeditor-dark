...
function OverviewView({
 ...
 <h3 className="text-lg font-bold text-foreground">Domaines Analysés</h3>
 </div>
 <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
 <div className="rounded-lg border-2-green-200 bg-green-50 p-4">
 ...
 <div className="rounded-lg border-2-red-200 bg-red-50 p-4">
 <div className="mb-2 flex items-center gap-2">
 ...
 <div
 key={intent}
 className="rounded-lg border-2-purple-200 bg-purple-50 p-4 text-center"
 >
 ...
 UNKNOWN: 'border bg-gray-50 text-gray-700',
 }
 return (
 <div
 key={level}
...
function KeywordCard({
 ...
 UNKNOWN: 'bg-muted/50 text-gray-700',
 }
