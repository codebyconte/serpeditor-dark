...
export default function CompetitorsAnalyzerPage() {
 ...
 className="w-full rounded-xl border-2 py-3 pr-4 pl-12 text-lg focus:border-ring focus:ring-4 focus:ring-ring/20"
 disabled={loading}
 />
 </div>
 ...
 <label className="flex items-center gap-3 rounded-xl border-2 bg-card px-4 py-3 hover:bg-card">
 <input
 type="checkbox"
 ...
 className="flex w-full items-center justify-center gap-3 rounded-xl border-2-primary bg-primary py-4 text-base font-semibold text-primary-foreground shadow-lg transition-all hover:bg-primary/90 hover:shadow-xl disabled:cursor-not-allowed disabled:opacity-50 disabled:border-primary/50"
 >
 {loading ? (
 <>
