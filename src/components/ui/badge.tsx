...
import { TouchTarget } from '../dashboard/button'
...
const colors = {
  ...
  zinc: 'bg-zinc-600/20 text-zinc-600 group-data-hover:bg-zinc-600/20 dark:bg-white/5 dark:text-zinc-100 dark:group-data-hover:bg-white/10',
}
